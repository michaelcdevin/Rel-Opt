function[cost, rel] =...
    Failure_Cost_Compute_returnfails(AnchorsOverstrengthened, OverstrengthFactors,...
...
% Calculate reliability, as per original code from Hallowell
...
rel = -norminv(1-(1-TurbnafT(1))*(1-TurbnafT(2))*(1-TurbnafT(3)));
